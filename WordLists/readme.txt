...
1. create a file for commands: project_words.txt to your folder space
2. in your build environment, add a prebuild task to invoke:
    python parsewords.py project_words.txt
...
3. add words to project_words.txt as needed. The format will be:
